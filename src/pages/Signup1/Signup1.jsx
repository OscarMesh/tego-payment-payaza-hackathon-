    ...
    <div className='signup'>
        <div className='container'>
            ...
            <div className='container1'>
                ...
                <p>Please enter your email address or phone number and password to a new your account</p>
                ...
                <form>
                    ...
                    <input  className="input" type='password' placeholder="Confirm Password" /> <br/>
